...
<html>
   <head>
        <title>Recanto Ferraz | Lista de Solisitações</title>
        <meta charset="UTF-8">
    ...
    Recanto Ferraz
       ...
       <h2 class="text-center corVerde py-2">Lista de Solicitações</h2>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                            ArrayList<Solicitacao> lista = SolicitacaoBD.listar();
                ...
                <tr>
                            ...
                            <td><%=solicitacao.getTelefone()%> <br> <%=solicitacao.getEmail()%></td>
                            <td><%=solicitacao.getTitulo()%></td>
                            <td><strong>Início: </strong><%=formato.format(solicitacao.getStart())%> <br>
                                <strong>Final: </strong><%=formato.format(solicitacao.getEnd())%>
                            </td>
                            <td><%=solicitacao.getPacote().getNome()%></td>
                      <td>
                       <a class="btn btn-dark"style="background-color: #406028;" href="../Reserva/cadastro.jsp">Confirmar</a>
                        <a class="btn btn-dark"style="background-color: #406028;" href="excluir.jsp?codigo=<%=solicitacao.getCodigo()%>" onclick="return confirm('Deseja realmente excluir?')">Excluir</a>
                    </td>
                </tr>
                <%
            }
