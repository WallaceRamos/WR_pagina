    ...
    Recanto Ferraz
                        ...
                        <div class="collapse navbar-collapse" id="navbarResponsive">
                            ...
                            <ul class="navbar-nav mx-auto">
                                <li class="nav-item">
                                <a class="nav-link text-white" href="listaCliente.jsp">Clientes</a>
                            </li>
       ...
       <div class="container-fluid " id="interface">
            ...
            <%
                ...
                String pacote = request.getParameter("codigo");
                if (pacote != null) {
                    reserva = ReservaBD.getByCodigo(pacote);
                    ...
                    <div class="form">
                        <form name="formaCadastro" method="post" action="../Reserva/cadastro.jsp">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" id="title" placeholder="Título do evento">
                                </div>
                            </div>
                            <div class="form-group row">
    ...
    <div class="modal fade" id="cadastrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="formaCadastro" method="post" action="">
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Título:</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="title" id="title" placeholder="Título do evento">
